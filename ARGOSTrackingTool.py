...
#
# Author: Yingfan Zeng (yingfan.zeng@duke.edu)
# Date:   Fall 2021
#--------------------------------------------------------------

#Ask user for the search date
user_date = "7/12/2003" #input("Enter date to search for Sara:")
...
for lineString in line_list:
    ...
    if obs_lc in ("1", "2", "3"):
        #print(f"Record {record_id} indicates Sara was at lat:{obs_lat}, lon:{obs_lon} on {obs_date}")
...
for matching_key in matching_keys:
    ...
    print(f"Record {matching_key} indicates Sara was at lat:{obs_lat}, lon:{obs_lon} on {user_date}")